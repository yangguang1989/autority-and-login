...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/orders/update.do"
				method="post">
						...
						<div class="row data-type">
							...
							<div class="col-md-4 data">
								<input type="text" class="form-control" placeholder="订单名称"
									   name="orderName" value="${orders.orderName}">
							</div>
							...
							<div class="col-md-4 data">
								<select class="form-control select2" style="width: 100%"
										name="payType">
									<option value="${orders.payType}">${orders.payType==0?"支付宝":"微信"}</option>
							...
							<div class="col-md-4 data">
								<select class="form-control select2" style="width: 100%"
										name="orderStatus">
									<option value="${orders.orderStatus}">${orders.orderStatus==0?"未支付":"已支付"}</option>
